...
using VirtualStorePlace.RealiseInterfaceBD;
...
namespace VirtualStoreWeb
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IBuyerCustomer, BuyerServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IElementService, ElementServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IKitchenerService, KitchenerServiceBD>(new HierarchicalLifetimeManager());
